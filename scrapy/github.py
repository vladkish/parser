...
def github_projects():
    ...
    #     profile = session.get(link, headers=headers)
    ...
    data = {'LoginForm[login]' : 'kishkovarv@gmail.com', 'LoginForm[password]' : 'Kish2008V'}
    ...
    if responce.status_code == 200:
        ...
        # Session 2 for job in site
        session2 = requests.Session()

        # broadcats cookies in session 2
        for cookies in cookies_dict:
            session2.cookies.set(**cookies)
        
        responce = session2.get('https://streetwear.com.ua/profile', headers=headers)
